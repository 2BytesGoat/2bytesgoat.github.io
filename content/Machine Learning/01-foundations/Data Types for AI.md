...
>
> _If this example doesn't make full sense to you, that's ok, we'll go into more details in further blog posts_
...
Time series is tabular data where the order **_does_** matter. Each row is a snapshot at a specific time (or a time window), so if you shuffle the rows you lose information.
...
If you’re still deciding _how_ to attack the problem once you know the data shape, [[Picking the Right AI]] is the checklist I use.
