...
>
> - `Idea:` something you could make/write someday
> - `Read:` book/paper/post/video worth remembering (+ one line why)
> - `Built:` thing you made, even tiny
> - `Asked:` someone asked me ML/game stuff — the question verbatim (free post material)
> - `Cool:` random thing that sparked joy (link, meme, technique)
>
> Tag when 即composted → `[post]` people would enjoy · `[note]` just for me

## Backlog seed (from the 2026-08-29 interview)

- `Built` [post] Arcade machine v2 — sitting in the room right now, needs finishing (hardware build, presented v1 at a Cluj conference)
